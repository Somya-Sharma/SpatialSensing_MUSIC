...
proc create_root_design { parentCell } {
  ...
  # Create instance: ULA_STREAM_0, and set properties
  set ULA_STREAM_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ULA_STREAM:1.0 ULA_STREAM_0 ]
  ...
  connect_bd_intf_net -intf_net ULA_STREAM_0_out_stream [get_bd_intf_pins ULA_STREAM_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins ULA_STREAM_0/in_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins ULA_STREAM_0/s_axi_CONTROL_BUS] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_net -net ULA_STREAM_0_interrupt [get_bd_pins ULA_STREAM_0/interrupt] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ULA_STREAM_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ULA_STREAM_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ULA_STREAM_0/s_axi_CONTROL_BUS/Reg] SEG_ULA_STREAM_0_Reg
