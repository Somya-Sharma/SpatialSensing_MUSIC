...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:MUSIC_SPARSE:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: MUSIC_SPARSE_0, and set properties
  set MUSIC_SPARSE_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:MUSIC_SPARSE:1.0 MUSIC_SPARSE_0 ]
  ...
  connect_bd_intf_net -intf_net MUSIC_SPARSE_0_out_stream [get_bd_intf_pins MUSIC_SPARSE_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins MUSIC_SPARSE_0/in_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins MUSIC_SPARSE_0/s_axi_CONTROL_BUS] [get_bd_intf_pins axi_interconnect_1/M01_AXI]
  ...
  connect_bd_net -net MUSIC_SPARSE_0_interrupt [get_bd_pins MUSIC_SPARSE_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net Net [get_bd_pins MUSIC_SPARSE_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins MUSIC_SPARSE_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MUSIC_SPARSE_0/s_axi_CONTROL_BUS/Reg] SEG_MUSIC_SPARSE_0_Reg
