start_gui
create_project DPR_proj C:/DPR_MUSIC/Tutorial/SAA/DPR_proj -part xc7z020clg484-1
set_property board_part em.avnet.com:zed:part0:1.4 [current_project]

set_property  ip_repo_paths  {C:/DPR_MUSIC/Tutorial/SAA/SAA_static/ip C:/DPR_MUSIC/Tutorial/SAA/IP_BB} [current_project]
update_ip_catalog
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
user.org:user:SAA_Recon:1.0\
xilinx.com:hls:SAA_static:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: SAA_Recon_0, and set properties
  set SAA_Recon_0 [ create_bd_cell -type ip -vlnv user.org:user:SAA_Recon:1.0 SAA_Recon_0 ]

  # Create instance: SAA_static_0, and set properties
  set SAA_static_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:SAA_static:1.0 SAA_static_0 ]
  ...
  connect_bd_intf_net -intf_net SAA_Recon_0_out_stream [get_bd_intf_pins SAA_Recon_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net SAA_static_0_out_stream [get_bd_intf_pins SAA_Recon_0/in_stream] [get_bd_intf_pins SAA_static_0/out_stream]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins SAA_static_0/in_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins SAA_static_0/s_axi_CONTROL_BUS] [get_bd_intf_pins axi_interconnect_1/M00_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins SAA_Recon_0/ap_rst_n] [get_bd_pins SAA_static_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SAA_Recon_0/ap_clk] [get_bd_pins SAA_static_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SAA_static_0/s_axi_CONTROL_BUS/Reg] SEG_SAA_static_0_Reg
  ...
  make_wrapper -files [get_files C:/DPR_MUSIC/Tutorial/SAA/DPR_proj/DPR_proj.srcs/sources_1/bd/bd_dpr/bd_dpr.bd] -top
  add_files -norecurse C:/DPR_MUSIC/Tutorial/SAA/DPR_proj/DPR_proj.srcs/sources_1/bd/bd_dpr/hdl/bd_dpr_wrapper.v
